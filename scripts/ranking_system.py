...
def merge_data():
    ...
    for the final scoring and ranking. 
...
def cal_score_rank(df_merged):
    """
    This function calculates a ranking score for each merchant and the top 100 merchants 
    will be saved in "../data/curated/top100.csv" with their information.
    """
